...
The plots were derived from 103 local to regional datasets. To improve the representation of Earth’s environmental conditions, these plots are a sample from a larger pool of vegetation plots using an environmentally stratified sampling design.
